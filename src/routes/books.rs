...
pub async fn search_by_title(
    ...
    match books {
        Ok(books) => HttpResponse::Ok().json(books),
        Err(_) => HttpResponse::BadRequest().body("Error getting books with provided title"),
    }
}
...
pub async fn search_by_publisher(
    ...
    match books {
        Ok(books) => HttpResponse::Ok().json(books),
        Err(_) => HttpResponse::BadRequest().body("Error getting books with provided publisher"),
    }
}
